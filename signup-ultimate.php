...
<html>
<head>
<title>Ultimate Website Sign-Up  </title>
...
<link rel="stylesheet" type="text/css" href="css/styleNEWFORM.css" media="all" />
    ...
    <div class="headerintro">
            <header>
                <h1><br><br><center>Ultimate Website Sign-Up</center></h1><p><center>$9/month, billed annually</center></p><br>
            </header>   <br><br>    
        </div>
...
<br><form action="chargeUltimate.php" method="post" align="center" onclick="sendTheMail(); return false">
  <script src="https://checkout.stripe.com/v2/checkout.js" class="stripe-button"
          data-key="<?php echo $stripe['publishable_key']; ?>"
          data-amount="10800" 
          data-description="12 months ($9/month)" 
          data-image="img/pandalogoStripe.png"
          data-name="Ultimate Website Design"
